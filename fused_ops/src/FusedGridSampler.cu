...
torch::Tensor fused_grid_sampler_3d_forward_impl(
    ...
    // std::cout << "batch_size_max: " << batch_size_max << std::endl;
    // std::cout << "input broadcast: " << broadcast_input << std::endl;
    // std::cout << "affine_3d broadcast: " << broadcast_affine_3d << std::endl;
